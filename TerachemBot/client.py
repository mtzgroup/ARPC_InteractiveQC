...
class Client(object):
    ...
    def poll_for_results(self, job_id, sleep_seconds=1, max_poll=100):
    ...
    def poll_for_bulk_results(self, job_ids, sleep_seconds=1, max_poll=100):
        """Send http request every sleep_seconds seconds until a finished job is
        returned or max_poll requests have been sent.
    ...
    def compute(self, geom, options, sleep_seconds=1, max_poll=100):
    ...
    def compute_bulk(self, geoms, options, sleep_seconds=1, max_poll=20):
